...
public class SQL {
	...
	public static Connection connectFF() {
		  Connection c = null;
		    try {
	...
	public static void save(String[] ara, int lvl, int slot) {
	...
	public static void overwrite(String[] ara, int lvl, int slot) {
		Connection c = connectFF();
		PreparedStatement savestmt;
	...
	public static int loadLevel(int save) {
		int ret = -1;
		Connection c = connectFF();
	...
	public static String[] loadParty(int save) {
