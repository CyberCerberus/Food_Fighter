...
public class Content {
    ...
    public static BufferedImage BACKGROUND_MENU = loadImage("/backgrounds/food_fighter_4.png");
    public static BufferedImage BACKGROUND_LEVEL1 = loadImage("/backgrounds/restaurant.jpg");
    public static BufferedImage BACKGROUND_CROPPED_LEVEL1 = loadImage("/backgrounds/cropped_restaurant.gif");
    public static BufferedImage BACKGROUND_CROPPED_LEVEL2 = loadImage("/backgrounds/cropped_candy_factory.gif");
    ...
    public static BufferedImage[][] HERO_BLUE = load("/sprites/player/blueLady.png", 64, 64);
    public static BufferedImage[][] HEAL = load("/sprites/player/heal.png", 192, 192);
    public static BufferedImage[][] HERO_BALD = load("/sprites/player/baldDude.png", 64, 64);
    ...
    public static BufferedImage[][] FIRE = load("/sprites/monsters/fire.png", 200, 200);
    public static BufferedImage DOOR = loadImage("/tiles/door.jpg");
    public static BufferedImage FLOOR = loadImage("/tiles/floor.jpg");
