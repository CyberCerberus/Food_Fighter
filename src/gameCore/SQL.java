...
public class SQL {
	...
	private static void fillTables(Connection c) throws SQLException {
		...
		String sql = ""
				 ...
				 + "0, 0.0, 1.0, 1.0, 1.0, 0, 0, 2, 0), (15, 'Tall Order', ' Reduce target speed by 20% ', ' ordered the house special ', "
				 + "0, 0.0, 1.0, 1.0, 0.8, 0, 0, 1, 0), (16, 'Famine Fist', ' Inflict 100 damage to target ', ' heavily punched ', "
				 + "-200, 0.0, 1.0, 1.0, 1.0, 0, 0, 4, 0)"
     		     + ";"
     		     + ""
     		     ...
     		     + "-1, .25, -1, 0, -1, 0) , (1, 'Snacker', 'Weak hunger beast', 10, 150, 30, 5, 12,"
     		     + "-1, 0, -1, 0, -1, 0), (2, 'Bruncher', 'Normal hunger beast', 20, 170, 45, 10, 15,"
     		     + "-1, 0.15, -1, 0, -1, 0), (3, 'Feaster', 'Strong hunger beast', 30, 200, 55, 15, 18,"
     		     + "-1, 0.18, -1, 0.1, -1, 0), (4, 'Glutton', 'Insane hunger beast', 60, 250, 70, 25, 10,"
     		     + "-1, 0.10, -1, 0, -1, 0), (5, 'Hollow', 'Hunger incarnate', 200, 450, 90, 30, 5,"
     		     + "-1, 0.20, -1, 0, -1, 0.30)"
     		     + ";"
     		     + ""
