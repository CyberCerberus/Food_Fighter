...
public class Party {
	...
	Character[] characters = {slot1, slot2, slot3, slot4};
	for(int i = 0; i < characters.length; i++){
	    if(characters[i].getSpd() > slowest){
		slowest = characters[i].getSpd();
