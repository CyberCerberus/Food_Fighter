...
public class Hero extends Character{
	...
	this.nextLVUP = 10;
	this.build = b;
	if(className.equalsIgnoreCase("vegan")){
	    animation = new ImageAnimation(Content.HERO_WIDTH, Content.HERO_HEIGHT, Content.HERO_BLUE[Content.HERO_HORIZONTAL]);
	}
	else{
	...
	setHealthbar((int)(1/(double)getMax() * hp * getMaxHealthbar()));
	...
	if (isDead()) {
		g.drawImage(Content.DEAD, x, y, 32, 32, null);
	    }
